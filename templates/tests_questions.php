...
<div>
    ...
    <div class="row mt-3 justify-content-between">
        <div class="col">
            <div class="tests-dropdown" id="tests-dropdown">
                <button class="btn btn-outline-primary btn-sm dropdown-toggle" type="button" id="tests-dropdown-list"
        ...
        <div class="col-12">
            <form method="post" action="<?php echo admin_url( 'admin-post.php' ) ?>" id="question-form">
                ...
                <div class="form-group col-sm-12">
                    <label class="col-form-label" for="new-test_name">Текст питання</label>
                    <div>
                        <input type="text" name="question_text" class="form-control" id="new-test_name" required>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <table data-list-type="question" data-test-id="<?php echo $current_test_id; ?>" class="table table-editable table-striped table-sm mt-3 <?php echo is_numeric( $current_test_id ) ? "" : "d-none" ?>"
                            ...
                            <td>
                                <div class="d-flex form-inline">
                                    <div class="justify-content-start form-check">
                                        ...
                                        <label class="form-check-label" for="checkbox_<?php echo $question['id']; ?>">
                                            Питання активне
                                        </label>
                                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-secondary py-1 px-2" data-dismiss="modal">Відміна</button>
